            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div className="p-3 rounded-lg bg-[#0c1422] border border-[#1a273b] space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[9px] text-zinc-400">USD / 1% BTC move</span>
                    </div>
                ...
                <div className="p-3 rounded-lg bg-[#0c1422] border border-[#1a273b] space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[9px] text-zinc-400">USD / 1 vol point</span>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <div className="p-3 rounded-lg bg-[#0c1422] border border-[#1a273b] space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[9px] text-zinc-400">USD / day decay</span>
                    </div>
                    <div className="flex items-center gap-3">
